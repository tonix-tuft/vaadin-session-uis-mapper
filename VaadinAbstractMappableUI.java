...
/**
 * A base abstract class which provides the basic mapping for the current UI using th {@link VaadinSessionUIsMapper} singleton class.
 * 
...
public abstract class VaadinAbstractMappableUI extends UI {
	...
	/**
	 * A boolean which tells whether the class was overridden in a bad way 
	 * (i.e. the constructor didn't call the super implementation). The default value is false 
	...
	/** 
	 * Gets whether the child class has overridden this class in a bad way (without calling the super implementation)
	 * 
	 * @return boolean True if the class has called the super constructor, false otherwise.
	 */
